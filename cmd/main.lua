...
elseif command == 'build' then
  ...
  if arg2 == 'windows' then
    if file_exists("C:\\Program Files\\7-Zip\\7z.exe") then
      os.execute('cd ' .. project_folder .. '\\love\ && build_windows.bat ' .. arg1)

    else
      print("error: building for windows requires 7-Zip to be installed")
      print('       more specifically, this path needs to exist: "C:\\Program Files\\7-Zip\\7z.exe"')
      return
    end
  end
end
